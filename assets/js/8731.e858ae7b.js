"use strict";
(self["webpackChunkmy_docs"] = self["webpackChunkmy_docs"] || []).push([[8731],{
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Bd: () => (/* binding */ findNodesForProperty),
/* harmony export */   P3: () => (/* binding */ getRuleType),
/* harmony export */   PV: () => (/* binding */ getExplicitRuleType),
/* harmony export */   Rp: () => (/* binding */ findAssignment),
/* harmony export */   S: () => (/* binding */ terminalRegex),
/* harmony export */   SS: () => (/* binding */ findNodeForKeyword),
/* harmony export */   U5: () => (/* binding */ findNameAssignment),
/* harmony export */   Uz: () => (/* binding */ getTypeName),
/* harmony export */   Xq: () => (/* binding */ isDataTypeRule),
/* harmony export */   YV: () => (/* binding */ getAllReachableRules),
/* harmony export */   eb: () => (/* binding */ isCommentTerminal),
/* harmony export */   g4: () => (/* binding */ getCrossReferenceTerminal),
/* harmony export */   qO: () => (/* binding */ findNodeForProperty)
/* harmony export */ });
...
/* harmony import */ var _utils_errors_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1564);
/* harmony import */ var _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2151);
/* harmony import */ var _syntax_tree_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2479);
/* harmony import */ var _ast_utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9683);
/* harmony import */ var _cst_utils_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6373);
/* harmony import */ var _regexp_utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2806);
/******************************************************************************
...
function getEntryRule(grammar) {
    return grammar.rules.find(e => _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isParserRule */ .s7(e) && e.entry);
}
/**
 * Returns all hidden terminal rules of the given grammar, if any.
 */
function getHiddenRules(grammar) {
    return grammar.rules.filter((e) => _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isTerminalRule */ .rE(e) && e.hidden);
}
/**
...
function getAllReachableRules(grammar, allTerminals) {
    ...
    for (const rule of grammar.rules) {
        if (ruleNames.has(rule.name) || (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isTerminalRule */ .rE(rule) && rule.hidden)) {
            rules.add(rule);
        }
    }
    return rules;
...
function ruleDfs(rule, visitedSet, allTerminals) {
    ...
    (0,_ast_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .streamAllContents */ .Uo)(rule).forEach(node => {
        if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isRuleCall */ .$g(node) || (allTerminals && _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isTerminalRuleCall */ .lF(node))) {
...
function isCommentTerminal(terminalRule) {
    return terminalRule.hidden && !(0,_regexp_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .isWhitespace */ .Yv)(terminalRegex(terminalRule));
}
/**
...
function findNodesForPropertyInternal(node, property, element, first) {
    if (!first) {
        const nodeFeature = (0,_ast_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .getContainerOfType */ .XG)(node.grammarSource, _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isAssignment */ .wh);
        if (nodeFeature && nodeFeature.feature === property) {
            return [node];
        }
    }
    if ((0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_3__/* .isCompositeCstNode */ .mD)(node) && node.astNode === element) {
...
function findNodesForKeywordInternal(node, keyword, element) {
    ...
    if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isKeyword */ .wb(node.grammarSource) && node.grammarSource.value === keyword) {
        return [node];
    }
    const treeIterator = (0,_cst_utils_js__WEBPACK_IMPORTED_MODULE_4__/* .streamCst */ .NS)(node).iterator();
    let result;
    const keywordNodes = [];
    do {
        ...
        if (!result.done) {
            ...
            if (childNode.astNode === element) {
                if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isKeyword */ .wb(childNode.grammarSource) && childNode.grammarSource.value === keyword) {
...
function findAssignment(cstNode) {
    ...
    while (astNode === ((_a = cstNode.container) === null || _a === void 0 ? void 0 : _a.astNode)) {
        const assignment = (0,_ast_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .getContainerOfType */ .XG)(cstNode.grammarSource, _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isAssignment */ .wh);
        if (assignment) {
            return assignment;
        }
...
function findNameAssignment(type) {
    let startNode = type;
    if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isInferredType */ .SP(startNode)) {
        // for inferred types, the location to start searching for the name-assignment is different
        if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isAction */ .ve(startNode.$container)) {
            // a type which is explicitly inferred by an action: investigate the sibbling of the Action node, i.e. start searching at the Action's parent
            startNode = startNode.$container.$container;
        }
        else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isParserRule */ .s7(startNode.$container)) {
            // investigate the parser rule with the explicitly inferred type
            startNode = startNode.$container;
        }
        else {
            (0,_utils_errors_js__WEBPACK_IMPORTED_MODULE_5__/* .assertUnreachable */ .d)(startNode.$container);
        }
    }
...
function findNameAssignmentInternal(type, startNode, cache) {
    ...
    function go(node, refType) {
        ...
        const parentAssignment = (0,_ast_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .getContainerOfType */ .XG)(node, _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isAssignment */ .wh);
    ...
    for (const node of (0,_ast_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .streamAllContents */ .Uo)(startNode)) {
        if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isAssignment */ .wh(node) && node.feature.toLowerCase() === 'name') {
            cache.set(type, node);
            return node;
        }
        else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isRuleCall */ .$g(node) && _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isParserRule */ .s7(node.rule.ref)) {
            return go(node, node.rule.ref);
        }
        else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isSimpleType */ .D8(node) && ((_a = node.typeRef) === null || _a === void 0 ? void 0 : _a.ref)) {
...
function isDataTypeRuleInternal(rule, visited) {
    ...
    for (const node of (0,_ast_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .streamAllContents */ .Uo)(rule)) {
        if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isRuleCall */ .$g(node)) {
            if (!node.rule.ref) {
                // RuleCall to unresolved rule. Don't assume `rule` is a DataType rule.
                return false;
            }
            if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isParserRule */ .s7(node.rule.ref) && !isDataTypeRuleInternal(node.rule.ref, visited)) {
                return false;
            }
        }
        else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isAssignment */ .wh(node)) {
            return false;
        }
        else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isAction */ .ve(node)) {
            return false;
        }
    }
...
function getExplicitRuleType(rule) {
    if (rule.inferredType) {
        ...
        if (refType) {
            ...
            if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isParserRule */ .s7(refType)) {
                return refType.name;
            }
            else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isInterface */ .S2(refType) || _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isType */ .Xj(refType)) {
                return refType.name;
            }
        }
    }
...
function getTypeName(type) {
    var _a;
    if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isParserRule */ .s7(type)) {
        return isDataTypeRule(type) ? type.name : (_a = getExplicitRuleType(type)) !== null && _a !== void 0 ? _a : type.name;
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isInterface */ .S2(type) || _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isType */ .Xj(type) || _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isReturnType */ .fG(type)) {
        return type.name;
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isAction */ .ve(type)) {
        const actionType = getActionType(type);
        if (actionType) {
            return actionType;
        }
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isInferredType */ .SP(type)) {
        return type.name;
    }
...
function getRuleType(rule) {
    var _a, _b, _c;
    if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isTerminalRule */ .rE(rule)) {
        return (_b = (_a = rule.type) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : 'string';
    }
    else {
...
function abstractElementToRegex(element, flags) {
    if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isTerminalAlternatives */ .Fy(element)) {
        return terminalAlternativesToRegex(element);
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isTerminalGroup */ .O4(element)) {
        return terminalGroupToRegex(element);
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isCharacterRange */ .Bg(element)) {
        return characterRangeToRegex(element);
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isTerminalRuleCall */ .lF(element)) {
    ...
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isNegatedToken */ .GL(element)) {
        return negateTokenToRegex(element);
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isUntilToken */ .Mz(element)) {
        return untilTokenToRegex(element);
    }
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isRegexToken */ .vd(element)) {
    ...
    else if (_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isWildcard */ .z2(element)) {
...
function keywordToRegex(keyword) {
    return (0,_regexp_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .escapeRegExp */ .Nt)(keyword.value);
}
...
/* harmony import */ var _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3579);
/* harmony import */ var langium__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4298);
/* harmony import */ var langium__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9364);
/* harmony import */ var langium__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8913);
...
var RadarTokenBuilder = class extends _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .AbstractMermaidTokenBuilder */ .mR {
  static {
    (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "RadarTokenBuilder");
  }
  constructor() {
    super(["radar-beta"]);
  }
...
var RadarModule = {
  parser: {
    TokenBuilder: /* @__PURE__ */ (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => new RadarTokenBuilder(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => new _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CommonValueConverter */ .Tm(), "ValueConverter")
  }
};
function createRadarServices(context = langium__WEBPACK_IMPORTED_MODULE_1__/* .EmptyFileSystem */ .D) {
  const shared = (0,langium__WEBPACK_IMPORTED_MODULE_2__/* .inject */ .WQ)(
    ...
    _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .MermaidGeneratedSharedModule */ .sr
  );
  const Radar = (0,langium__WEBPACK_IMPORTED_MODULE_2__/* .inject */ .WQ)(
    ...
    _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .RadarGeneratedModule */ .YP,
    RadarModule
  );
  shared.ServiceRegistry.register(Radar);
  return { shared, Radar };
}
(0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(createRadarServices, "createRadarServices");
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   W: () => (/* binding */ ErrorWithLocation),
/* harmony export */   d: () => (/* binding */ assertUnreachable)
/* harmony export */ });
/******************************************************************************
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   B5: () => (/* binding */ EMPTY_STREAM),
/* harmony export */   Rf: () => (/* binding */ DONE_RESULT),
/* harmony export */   Td: () => (/* binding */ stream),
/* harmony export */   Vj: () => (/* binding */ TreeStreamImpl),
/* harmony export */   fq: () => (/* binding */ StreamImpl),
/* harmony export */   iD: () => (/* binding */ Reduction)
/* harmony export */ });
/******************************************************************************
 * Copyright 2021 TypeFox GmbH
 * This program and the accompanying materials are made available under the
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Q: () => (/* binding */ DefaultTokenBuilder)
/* harmony export */ });
/* harmony import */ var chevrotain__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9637);
/* harmony import */ var _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2151);
/* harmony import */ var _utils_ast_utils_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9683);
/* harmony import */ var _utils_grammar_utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(418);
/* harmony import */ var _utils_regexp_utils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2806);
/* harmony import */ var _utils_stream_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1719);
/******************************************************************************
 * Copyright 2021 TypeFox GmbH
 * This program and the accompanying materials are made available under the
 * terms of the MIT License, which is available in the project root.
...
class DefaultTokenBuilder {
    ...
    buildTokens(grammar, options) {
        const reachableRules = (0,_utils_stream_js__WEBPACK_IMPORTED_MODULE_1__/* .stream */ .Td)((0,_utils_grammar_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .getAllReachableRules */ .YV)(grammar, false));
        const terminalTokens = this.buildTerminalTokens(reachableRules);
        const tokens = this.buildKeywordTokens(reachableRules, terminalTokens, options);
        terminalTokens.forEach(terminalToken => {
            const pattern = terminalToken.PATTERN;
            if (typeof pattern === 'object' && pattern && 'test' in pattern && (0,_utils_regexp_utils_js__WEBPACK_IMPORTED_MODULE_3__/* .isWhitespace */ .Yv)(pattern)) {
    ...
    buildTerminalTokens(rules) {
        return rules.filter(_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_4__/* .isTerminalRule */ .rE).filter(e => !e.fragment)
            .map(terminal => this.buildTerminalToken(terminal)).toArray();
    }
    buildTerminalToken(terminal) {
        const regex = (0,_utils_grammar_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .terminalRegex */ .S)(terminal);
        ...
        if (terminal.hidden) {
            ...
            tokenType.GROUP = (0,_utils_regexp_utils_js__WEBPACK_IMPORTED_MODULE_3__/* .isWhitespace */ .Yv)(regex) ? chevrotain__WEBPACK_IMPORTED_MODULE_0__/* .Lexer */ .JG.SKIPPED : 'hidden';
        }
        return tokenType;
    }
    ...
    buildKeywordTokens(rules, terminalTokens, options) {
        return rules
            ...
            .filter(_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_4__/* .isParserRule */ .s7)
            .flatMap(rule => (0,_utils_ast_utils_js__WEBPACK_IMPORTED_MODULE_5__/* .streamAllContents */ .Uo)(rule).filter(_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_4__/* .isKeyword */ .wb))
    ...
    buildKeywordPattern(keyword, caseInsensitive) {
        return caseInsensitive ?
            new RegExp((0,_utils_regexp_utils_js__WEBPACK_IMPORTED_MODULE_3__/* .getCaseInsensitivePattern */ .Ao)(keyword.value)) :
            keyword.value;
    }
    findLongerAlt(keyword, terminalTokens) {
        return terminalTokens.reduce((longerAlts, token) => {
            const pattern = token === null || token === void 0 ? void 0 : token.PATTERN;
            if ((pattern === null || pattern === void 0 ? void 0 : pattern.source) && (0,_utils_regexp_utils_js__WEBPACK_IMPORTED_MODULE_3__/* .partialMatches */ .PC)('^' + pattern.source + '$', keyword.value)) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $g: () => (/* binding */ isRuleCall),
/* harmony export */   Bg: () => (/* binding */ isCharacterRange),
/* harmony export */   Ct: () => (/* binding */ isNegation),
/* harmony export */   Cz: () => (/* binding */ isBooleanLiteral),
/* harmony export */   D8: () => (/* binding */ isSimpleType),
/* harmony export */   FO: () => (/* binding */ isEndOfFile),
/* harmony export */   Fy: () => (/* binding */ isTerminalAlternatives),
/* harmony export */   GL: () => (/* binding */ isNegatedToken),
/* harmony export */   IZ: () => (/* binding */ isGroup),
/* harmony export */   Mz: () => (/* binding */ isUntilToken),
/* harmony export */   O4: () => (/* binding */ isTerminalGroup),
/* harmony export */   QX: () => (/* binding */ LangiumGrammarAstReflection),
/* harmony export */   RP: () => (/* binding */ isDisjunction),
/* harmony export */   S2: () => (/* binding */ isInterface),
/* harmony export */   SP: () => (/* binding */ isInferredType),
/* harmony export */   TF: () => (/* binding */ isParameterReference),
/* harmony export */   Tu: () => (/* binding */ isConjunction),
/* harmony export */   Xj: () => (/* binding */ isType),
/* harmony export */   _c: () => (/* binding */ isCrossReference),
/* harmony export */   cY: () => (/* binding */ isUnorderedGroup),
/* harmony export */   fG: () => (/* binding */ isReturnType),
/* harmony export */   jp: () => (/* binding */ isAlternatives),
/* harmony export */   lF: () => (/* binding */ isTerminalRuleCall),
/* harmony export */   r1: () => (/* binding */ isAbstractElement),
/* harmony export */   rE: () => (/* binding */ isTerminalRule),
/* harmony export */   s7: () => (/* binding */ isParserRule),
/* harmony export */   vd: () => (/* binding */ isRegexToken),
/* harmony export */   ve: () => (/* binding */ isAction),
/* harmony export */   wb: () => (/* binding */ isKeyword),
/* harmony export */   wh: () => (/* binding */ isAssignment),
/* harmony export */   z2: () => (/* binding */ isWildcard)
/* harmony export */ });
...
/* harmony import */ var _syntax_tree_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2479);
/******************************************************************************
...
class LangiumGrammarAstReflection extends _syntax_tree_js__WEBPACK_IMPORTED_MODULE_0__/* .AbstractAstReflection */ .kD {
    getAllTypes() {
...
/* harmony export */   FC: () => (/* binding */ isLeafCstNode),
/* harmony export */   Nr: () => (/* binding */ isAstNodeDescription),
/* harmony export */   Zl: () => (/* binding */ isLinkingError),
/* harmony export */   br: () => (/* binding */ isRootCstNode),
/* harmony export */   kD: () => (/* binding */ AbstractAstReflection),
/* harmony export */   mD: () => (/* binding */ isCompositeCstNode),
/* harmony export */   ng: () => (/* binding */ isAstNode)
/* harmony export */ });
/******************************************************************************
 * Copyright 2021 TypeFox GmbH
 * This program and the accompanying materials are made available under the
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Ao: () => (/* binding */ getCaseInsensitivePattern),
/* harmony export */   Nt: () => (/* binding */ escapeRegExp),
/* harmony export */   PC: () => (/* binding */ partialMatches),
/* harmony export */   TH: () => (/* binding */ NEWLINE_REGEXP),
/* harmony export */   Yv: () => (/* binding */ isWhitespace),
/* harmony export */   lU: () => (/* binding */ isMultilineComment)
/* harmony export */ });
/* unused harmony exports getTerminalParts, whitespaceCharacters, partialRegExp */
/* harmony import */ var _chevrotain_regexp_to_ast__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5186);
/******************************************************************************
 * Copyright 2021 TypeFox GmbH
 * This program and the accompanying materials are made available under the
 * terms of the MIT License, which is available in the project root.
...
const regexpParser = new _chevrotain_regexp_to_ast__WEBPACK_IMPORTED_MODULE_0__/* .RegExpParser */ .H();
/**
 ...
 */
class TerminalRegExpVisitor extends _chevrotain_regexp_to_ast__WEBPACK_IMPORTED_MODULE_0__/* .BaseRegExpVisitor */ .z {
    constructor() {
        super(...arguments);
...
var value_converter = __webpack_require__(5033);
// EXTERNAL MODULE: ./node_modules/langium/lib/parser/token-builder.js
var token_builder = __webpack_require__(1945);
...
var AbstractMermaidValueConverter = class extends value_converter/* DefaultValueConverter */.d {
  static {
...
var AbstractMermaidTokenBuilder = class extends token_builder/* DefaultTokenBuilder */.Q {
  static {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   D: () => (/* binding */ EmptyFileSystem)
/* harmony export */ });
...
/* harmony import */ var _baseIteratee_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3958);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   d: () => (/* binding */ DefaultValueConverter)
/* harmony export */ });
/* unused harmony export ValueConverter */
/* harmony import */ var _languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2151);
/* harmony import */ var _utils_grammar_utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(418);
/******************************************************************************
 * Copyright 2021 TypeFox GmbH
 * This program and the accompanying materials are made available under the
 * terms of the MIT License, which is available in the project root.
...
class DefaultValueConverter {
    convert(input, cstNode) {
        ...
        if ((0,_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isCrossReference */ ._c)(feature)) {
            feature = (0,_utils_grammar_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .getCrossReferenceTerminal */ .g4)(feature);
        }
        if ((0,_languages_generated_ast_js__WEBPACK_IMPORTED_MODULE_0__/* .isRuleCall */ .$g)(feature)) {
    ...
    runConverter(rule, input, cstNode) {
        ...
        switch ((_a = (0,_utils_grammar_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .getRuleType */ .P3)(rule)) === null || _a === void 0 ? void 0 : _a.toLowerCase()) {
...
var _baseIteratee = __webpack_require__(3958);
...
var toInteger = __webpack_require__(8593);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   El: () => (/* binding */ DefaultNameRegexp),
/* harmony export */   NS: () => (/* binding */ streamCst),
/* harmony export */   SX: () => (/* binding */ toDocumentSegment),
/* harmony export */   pO: () => (/* binding */ isChildNode),
/* harmony export */   r4: () => (/* binding */ inRange),
/* harmony export */   v: () => (/* binding */ findCommentNode),
/* harmony export */   wf: () => (/* binding */ tokenToRange)
/* harmony export */ });
...
/* harmony import */ var _syntax_tree_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2479);
/* harmony import */ var _stream_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1719);
/******************************************************************************
 * Copyright 2021 TypeFox GmbH
 * This program and the accompanying materials are made available under the
 * terms of the MIT License, which is available in the project root.
...
function streamCst(node) {
    return new _stream_js__WEBPACK_IMPORTED_MODULE_0__/* .TreeStreamImpl */ .Vj(node, element => {
        if ((0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_1__/* .isCompositeCstNode */ .mD)(element)) {
...
function findCommentNode(cstNode, commentNames) {
    if (cstNode) {
        ...
        if ((0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_1__/* .isRootCstNode */ .br)(cstNode)) {
...
function isCommentNode(cstNode, commentNames) {
    return (0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_1__/* .isLeafCstNode */ .FC)(cstNode) && commentNames.includes(cstNode.tokenType.name);
}
/**
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseExtremum_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2559);
/* harmony import */ var _baseLt_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6224);
/* harmony import */ var _identity_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9008);
...
var GitGraphTokenBuilder = class extends _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .AbstractMermaidTokenBuilder */ .mR {
  static {
    (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "GitGraphTokenBuilder");
  }
  constructor() {
    super(["gitGraph"]);
  }
...
var GitGraphModule = {
  parser: {
    TokenBuilder: /* @__PURE__ */ (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => new GitGraphTokenBuilder(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => new _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CommonValueConverter */ .Tm(), "ValueConverter")
  }
};
function createGitGraphServices(context = langium__WEBPACK_IMPORTED_MODULE_1__/* .EmptyFileSystem */ .D) {
  ...
  const GitGraph = (0,langium__WEBPACK_IMPORTED_MODULE_2__/* .inject */ .WQ)(
    (0,langium__WEBPACK_IMPORTED_MODULE_3__/* .createDefaultCoreModule */ .t)({ shared }),
    _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .GitGraphGeneratedModule */ .eZ,
    GitGraphModule
  );
  shared.ServiceRegistry.register(GitGraph);
  return { shared, GitGraph };
}
(0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(createGitGraphServices, "createGitGraphServices");
...
/* harmony export */ });
/* harmony import */ var _baseFlatten_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3588);
/* harmony import */ var _map_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4722);
...
function flatMap(collection, iteratee) {
  return (0,_baseFlatten_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)((0,_map_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(collection, iteratee), 1);
}
...
var InfoTokenBuilder = class extends _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .AbstractMermaidTokenBuilder */ .mR {
  static {
    (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "InfoTokenBuilder");
  }
  constructor() {
    super(["info", "showInfo"]);
  }
...
var InfoModule = {
  parser: {
    TokenBuilder: /* @__PURE__ */ (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => new InfoTokenBuilder(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => new _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CommonValueConverter */ .Tm(), "ValueConverter")
  }
};
function createInfoServices(context = langium__WEBPACK_IMPORTED_MODULE_1__/* .EmptyFileSystem */ .D) {
  ...
  const Info = (0,langium__WEBPACK_IMPORTED_MODULE_2__/* .inject */ .WQ)(
    (0,langium__WEBPACK_IMPORTED_MODULE_3__/* .createDefaultCoreModule */ .t)({ shared }),
    _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .InfoGeneratedModule */ .e5,
    InfoModule
  );
  shared.ServiceRegistry.register(Info);
  return { shared, Info };
}
(0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(createInfoServices, "createInfoServices");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _toFinite_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4342);
...
/* harmony import */ var _chunks_mermaid_parser_core_chunk_2NYFTIL2_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7123);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_EXZZNE6F_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8525);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_V4Q32G6S_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9923);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_ROXG7S4E_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9732);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_C4OEIS7N_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8815);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_2O5ZK7RR_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(655);
/* harmony import */ var _chunks_mermaid_parser_core_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3579);
...
var parsers = {};
var initializers = {
  info: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async () => {
    const { createInfoServices: createInfoServices2 } = await __webpack_require__.e(/* import() */ 7303).then(__webpack_require__.bind(__webpack_require__, 7303));
    const parser = createInfoServices2().Info.parser.LangiumParser;
    parsers.info = parser;
  }, "info"),
  packet: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async () => {
    const { createPacketServices: createPacketServices2 } = await __webpack_require__.e(/* import() */ 8313).then(__webpack_require__.bind(__webpack_require__, 694));
    const parser = createPacketServices2().Packet.parser.LangiumParser;
    parsers.packet = parser;
  }, "packet"),
  pie: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async () => {
    const { createPieServices: createPieServices2 } = await __webpack_require__.e(/* import() */ 9495).then(__webpack_require__.bind(__webpack_require__, 9495));
    const parser = createPieServices2().Pie.parser.LangiumParser;
    parsers.pie = parser;
  }, "pie"),
  architecture: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async () => {
    const { createArchitectureServices: createArchitectureServices2 } = await __webpack_require__.e(/* import() */ 2024).then(__webpack_require__.bind(__webpack_require__, 2024));
    const parser = createArchitectureServices2().Architecture.parser.LangiumParser;
    parsers.architecture = parser;
  }, "architecture"),
  gitGraph: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async () => {
    const { createGitGraphServices: createGitGraphServices2 } = await __webpack_require__.e(/* import() */ 9669).then(__webpack_require__.bind(__webpack_require__, 9669));
    const parser = createGitGraphServices2().GitGraph.parser.LangiumParser;
    parsers.gitGraph = parser;
  }, "gitGraph"),
  radar: /* @__PURE__ */ (0,_chunks_mermaid_parser_core_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async () => {
    const { createRadarServices: createRadarServices2 } = await __webpack_require__.e(/* import() */ 4564).then(__webpack_require__.bind(__webpack_require__, 4564));
...
(0,_chunks_mermaid_parser_core_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(parse, "parse");
var MermaidParseError = class extends Error {
  ...
  static {
    (0,_chunks_mermaid_parser_core_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(this, "MermaidParseError");
  }
};
...
var ArchitectureTokenBuilder = class extends _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .AbstractMermaidTokenBuilder */ .mR {
  static {
    (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "ArchitectureTokenBuilder");
  }
  constructor() {
    super(["architecture"]);
  }
...
var ArchitectureValueConverter = class extends _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .AbstractMermaidValueConverter */ .dg {
  static {
    (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "ArchitectureValueConverter");
  }
...
var ArchitectureModule = {
  parser: {
    TokenBuilder: /* @__PURE__ */ (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => new ArchitectureTokenBuilder(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => new ArchitectureValueConverter(), "ValueConverter")
  }
};
function createArchitectureServices(context = langium__WEBPACK_IMPORTED_MODULE_1__/* .EmptyFileSystem */ .D) {
  ...
  const Architecture = (0,langium__WEBPACK_IMPORTED_MODULE_2__/* .inject */ .WQ)(
    (0,langium__WEBPACK_IMPORTED_MODULE_3__/* .createDefaultCoreModule */ .t)({ shared }),
    _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .ArchitectureGeneratedModule */ .jE,
    ArchitectureModule
  );
  shared.ServiceRegistry.register(Architecture);
  return { shared, Architecture };
}
(0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(createArchitectureServices, "createArchitectureServices");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  t: () => (/* binding */ createDefaultCoreModule),
  u: () => (/* binding */ createDefaultSharedCoreModule)
});

// EXTERNAL MODULE: ./node_modules/langium/lib/utils/cst-utils.js
var cst_utils = __webpack_require__(6373);
// EXTERNAL MODULE: ./node_modules/langium/lib/utils/grammar-utils.js
var grammar_utils = __webpack_require__(418);
// EXTERNAL MODULE: ./node_modules/langium/lib/utils/regexp-utils.js
var regexp_utils = __webpack_require__(2806);
// EXTERNAL MODULE: ./node_modules/langium/lib/languages/generated/ast.js
var ast = __webpack_require__(2151);
...
function createGrammarConfig(services) {
    ...
    for (const rule of grammar.rules) {
        if ((0,ast/* isTerminalRule */.rE)(rule) && (0,grammar_utils/* isCommentTerminal */.eb)(rule) && (0,regexp_utils/* isMultilineComment */.lU)((0,grammar_utils/* terminalRegex */.S)(rule))) {
            rules.push(rule.name);
        }
    }
    return {
        multilineCommentRules: rules,
        nameRegexp: cst_utils/* DefaultNameRegexp */.El
    };
}
//# sourceMappingURL=grammar-config.js.map
// EXTERNAL MODULE: ./node_modules/chevrotain/lib/src/api.js + 69 modules
var api = __webpack_require__(9637);
...
var filter = __webpack_require__(4092);
...
function atom(atn, rule, production) {
    if (production instanceof api/* Terminal */.BK) {
        return tokenRef(atn, rule, production.terminalType, production);
    }
    else if (production instanceof api/* NonTerminal */.wL) {
        return ruleRef(atn, rule, production);
    }
    else if (production instanceof api/* Alternation */.ak) {
        return alternation(atn, rule, production);
    }
    else if (production instanceof api/* Option */.c$) {
        return atn_option(atn, rule, production);
    }
    else if (production instanceof api/* Repetition */.Y2) {
        return repetition(atn, rule, production);
    }
    else if (production instanceof api/* RepetitionWithSeparator */.Pp) {
        return repetitionSep(atn, rule, production);
    }
    else if (production instanceof api/* RepetitionMandatory */.$P) {
        return repetitionMandatory(atn, rule, production);
    }
    else if (production instanceof api/* RepetitionMandatoryWithSeparator */.Cy) {
...
function alternation(atn, rule, alternation) {
    ...
    const alts = (0,map/* default */.A)(alternation.definition, (e) => atom(atn, rule, e));
...
function block(atn, rule, block) {
    const handles = (0,filter/* default */.A)((0,map/* default */.A)(block.definition, (e) => atom(atn, rule, e)), (e) => e !== undefined);
    if (handles.length === 1) {
        return handles[0];
    }
...
function getProdType(production) {
    if (production instanceof api/* Alternation */.ak) {
        return 'Alternation';
    }
    else if (production instanceof api/* Option */.c$) {
        return 'Option';
...
class ATNConfigSet {
    ...
    get alts() {
        return (0,map/* default */.A)(this.configs, (e) => e.alt);
    }
    get key() {
        let value = "";
...
class LLStarLookaheadStrategy extends api/* LLkLookaheadStrategy */.T6 {
    constructor(options) {
        var _a;
        super();
    ...
    buildLookaheadForAlternation(options) {
        ...
        const partialAlts = (0,map/* default */.A)((0,api/* getLookaheadPaths */.jk)({
            maxLookahead: 1,
            occurrence: prodOccurrence,
            prodType: "Alternation",
            rule: rule
        }), (currAlt) => (0,map/* default */.A)(currAlt, (path) => path[0]));
    ...
    buildLookaheadForOptional(options) {
        ...
        const decisionState = this.atn.decisionMap[key];
        const decisionIndex = decisionState.decision;
        const alts = (0,map/* default */.A)((0,api/* getLookaheadPaths */.jk)({
            maxLookahead: 1,
            occurrence: prodOccurrence,
            prodType,
            rule
        }), (e) => {
            return (0,map/* default */.A)(e, (g) => g[0]);
        });
        if (isLL1Sequence(alts) && alts[0][0] && !dynamicTokensEnabled) {
            const alt = alts[0];
            const singleTokensTypes = (0,flatten/* default */.A)(alt);
...
function buildAmbiguityError(options) {
    const pathMsg = (0,map/* default */.A)(options.prefixPath, (currtok) => (0,api/* tokenLabel */.Sk)(currtok)).join(", ");
...
function getProductionDslName(prod) {
    if (prod instanceof api/* NonTerminal */.wL) {
        return "SUBRULE";
    }
    else if (prod instanceof api/* Option */.c$) {
        return "OPTION";
    }
    else if (prod instanceof api/* Alternation */.ak) {
        return "OR";
    }
    else if (prod instanceof api/* RepetitionMandatory */.$P) {
        return "AT_LEAST_ONE";
    }
    else if (prod instanceof api/* RepetitionMandatoryWithSeparator */.Cy) {
        return "AT_LEAST_ONE_SEP";
    }
    else if (prod instanceof api/* RepetitionWithSeparator */.Pp) {
        return "MANY_SEP";
    }
    else if (prod instanceof api/* Repetition */.Y2) {
        return "MANY";
    }
    else if (prod instanceof api/* Terminal */.BK) {
        return "CONSUME";
    }
    else {
...
function buildAdaptivePredictError(path, previous, current) {
    const nextTransitions = (0,flatMap/* default */.A)(previous.configs.elements, (e) => e.state.transitions);
...
function getReachableTarget(transition, token) {
    if (transition instanceof AtomTransition &&
        (0,api/* tokenMatcher */.G)(token, transition.tokenType)) {
...
var ast_utils = __webpack_require__(9683);
...
class CstNodeBuilder {
    ...
    buildLeafNode(token, feature) {
        const leafNode = new LeafCstNodeImpl(token.startOffset, token.image.length, (0,cst_utils/* tokenToRange */.wf)(token), token.tokenType, !feature);
    ...
    addHiddenNodes(tokens) {
        ...
        for (const token of tokens) {
            const leafNode = new LeafCstNodeImpl(token.startOffset, token.image.length, (0,cst_utils/* tokenToRange */.wf)(token), token.tokenType, true);
            leafNode.root = this.rootNode;
            nodes.push(leafNode);
        }
...
class LangiumParser extends AbstractLangiumParser {
    ...
    computeRuleType(rule) {
        ...
        else if ((0,grammar_utils/* isDataTypeRule */.Xq)(rule)) {
            return DatatypeSymbol;
        }
        else {
            const explicit = (0,grammar_utils/* getExplicitRuleType */.PV)(rule);
    ...
    consume(idx, tokenType, feature) {
        ...
        if (!this.isRecording() && this.isValidToken(token)) {
            ...
            const current = this.current;
            if (assignment) {
                const convertedValue = (0,ast/* isKeyword */.wb)(feature) ? token.image : this.converter.convert(token.image, leafNode);
                this.assign(assignment.operator, assignment.feature, convertedValue, leafNode, isCrossRef);
            }
            else if (isDataTypeNode(current)) {
                let text = token.image;
                if (!(0,ast/* isKeyword */.wb)(feature)) {
    ...
    construct() {
        ...
        (0,ast_utils/* linkContentToContainer */.SD)(obj);
        ...
        if (isDataTypeNode(obj)) {
            ...
            (0,ast_utils/* assignMandatoryProperties */.OP)(this.astReflection, obj);
        }
        return obj;
    }
    getAssignment(feature) {
        if (!this.assignmentMap.has(feature)) {
            const assignment = (0,ast_utils/* getContainerOfType */.XG)(feature, ast/* isAssignment */.wh);
            this.assignmentMap.set(feature, {
                assignment: assignment,
                isCrossRef: assignment ? (0,ast/* isCrossReference */._c)(assignment.terminal) : false
            });
        }
...
class AbstractParserErrorMessageProvider {
    buildMismatchTokenMessage(options) {
        return api/* defaultParserErrorProvider */.my.buildMismatchTokenMessage(options);
    }
    buildNotAllInputParsedMessage(options) {
        return api/* defaultParserErrorProvider */.my.buildNotAllInputParsedMessage(options);
    }
    buildNoViableAltMessage(options) {
        return api/* defaultParserErrorProvider */.my.buildNoViableAltMessage(options);
    }
    buildEarlyExitMessage(options) {
        return api/* defaultParserErrorProvider */.my.buildEarlyExitMessage(options);
    }
}
 ...
 */
class ChevrotainWrapper extends api/* EmbeddedActionsParser */.jr {
    constructor(tokens, config) {
        ...
        super(tokens, Object.assign(Object.assign(Object.assign({}, defaultConfig), { lookaheadStrategy: useDefaultLookahead
                ? new api/* LLkLookaheadStrategy */.T6({ maxLookahead: config.maxLookahead })
...
var errors = __webpack_require__(1564);
// EXTERNAL MODULE: ./node_modules/langium/lib/utils/stream.js
var stream = __webpack_require__(1719);
...
function buildRules(parserContext, grammar) {
    const reachable = (0,grammar_utils/* getAllReachableRules */.YV)(grammar, false);
    const parserRules = (0,stream/* stream */.Td)(grammar.rules).filter(ast/* isParserRule */.s7).filter(rule => reachable.has(rule));
...
function buildElement(ctx, element, ignoreGuard = false) {
    let method;
    if ((0,ast/* isKeyword */.wb)(element)) {
        method = buildKeyword(ctx, element);
    }
    else if ((0,ast/* isAction */.ve)(element)) {
        method = buildAction(ctx, element);
    }
    else if ((0,ast/* isAssignment */.wh)(element)) {
        method = buildElement(ctx, element.terminal);
    }
    else if ((0,ast/* isCrossReference */._c)(element)) {
        method = buildCrossReference(ctx, element);
    }
    else if ((0,ast/* isRuleCall */.$g)(element)) {
        method = buildRuleCall(ctx, element);
    }
    else if ((0,ast/* isAlternatives */.jp)(element)) {
        method = buildAlternatives(ctx, element);
    }
    else if ((0,ast/* isUnorderedGroup */.cY)(element)) {
        method = buildUnorderedGroup(ctx, element);
    }
    else if ((0,ast/* isGroup */.IZ)(element)) {
        method = buildGroup(ctx, element);
    }
    else if ((0,ast/* isEndOfFile */.FO)(element)) {
        const idx = ctx.consume++;
        method = () => ctx.parser.consume(idx, api/* EOF */.LT, element);
    }
    else {
        throw new errors/* ErrorWithLocation */.W(element.$cstNode, `Unexpected element type: ${element.$type}`);
    }
    return wrap(ctx, ignoreGuard ? undefined : getGuardCondition(element), method, element.cardinality);
}
function buildAction(ctx, action) {
    const actionType = (0,grammar_utils/* getTypeName */.Uz)(action);
    return () => ctx.parser.action(actionType, action);
}
function buildRuleCall(ctx, ruleCall) {
    const rule = ruleCall.rule.ref;
    if ((0,ast/* isParserRule */.s7)(rule)) {
        const idx = ctx.subrule++;
        const fragment = rule.fragment;
        const predicate = ruleCall.arguments.length > 0 ? buildRuleCallPredicate(rule, ruleCall.arguments) : () => ({});
        return (args) => ctx.parser.subrule(idx, getRule(ctx, rule), fragment, ruleCall, predicate(args));
    }
    else if ((0,ast/* isTerminalRule */.rE)(rule)) {
        const idx = ctx.consume++;
        const method = getToken(ctx, rule.name);
        return () => ctx.parser.consume(idx, method, ruleCall);
    }
    else if (!rule) {
        throw new errors/* ErrorWithLocation */.W(ruleCall.$cstNode, `Undefined rule: ${ruleCall.rule.$refText}`);
    }
    else {
        (0,errors/* assertUnreachable */.d)(rule);
    }
}
...
function buildPredicate(condition) {
    if ((0,ast/* isDisjunction */.RP)(condition)) {
        const left = buildPredicate(condition.left);
        const right = buildPredicate(condition.right);
        return (args) => (left(args) || right(args));
    }
    else if ((0,ast/* isConjunction */.Tu)(condition)) {
        const left = buildPredicate(condition.left);
        const right = buildPredicate(condition.right);
        return (args) => (left(args) && right(args));
    }
    else if ((0,ast/* isNegation */.Ct)(condition)) {
        const value = buildPredicate(condition.value);
        return (args) => !value(args);
    }
    else if ((0,ast/* isParameterReference */.TF)(condition)) {
        const name = condition.parameter.ref.name;
        return (args) => args !== undefined && args[name] === true;
    }
    else if ((0,ast/* isBooleanLiteral */.Cz)(condition)) {
        const value = Boolean(condition.true);
        return () => value;
    }
    (0,errors/* assertUnreachable */.d)(condition);
}
...
function buildCrossReference(ctx, crossRef, terminal = crossRef.terminal) {
    if (!terminal) {
        ...
        const assignment = (0,grammar_utils/* findNameAssignment */.U5)(crossRef.type.ref);
        const assignTerminal = assignment === null || assignment === void 0 ? void 0 : assignment.terminal;
        if (!assignTerminal) {
            throw new Error('Could not find name assignment for type: ' + (0,grammar_utils/* getTypeName */.Uz)(crossRef.type.ref));
        }
        return buildCrossReference(ctx, crossRef, assignTerminal);
    }
    else if ((0,ast/* isRuleCall */.$g)(terminal) && (0,ast/* isParserRule */.s7)(terminal.rule.ref)) {
        // The terminal is a data type rule here. Everything else will result in a validation error.
        const rule = terminal.rule.ref;
        const idx = ctx.subrule++;
        return (args) => ctx.parser.subrule(idx, getRule(ctx, rule), false, crossRef, args);
    }
    else if ((0,ast/* isRuleCall */.$g)(terminal) && (0,ast/* isTerminalRule */.rE)(terminal.rule.ref)) {
        const idx = ctx.consume++;
        const terminalRule = getToken(ctx, terminal.rule.ref.name);
        return () => ctx.parser.consume(idx, terminalRule, crossRef);
    }
    else if ((0,ast/* isKeyword */.wb)(terminal)) {
        const idx = ctx.consume++;
...
function wrap(ctx, guard, method, cardinality) {
    ...
    if (cardinality === '*') {
        ...
        (0,errors/* assertUnreachable */.d)(cardinality);
    }
}
...
function getRuleName(ctx, element) {
    if ((0,ast/* isParserRule */.s7)(element)) {
        return element.name;
    }
        ...
        while (!(0,ast/* isParserRule */.s7)(parent)) {
            if ((0,ast/* isGroup */.IZ)(parent) || (0,ast/* isAlternatives */.jp)(parent) || (0,ast/* isUnorderedGroup */.cY)(parent)) {
...
function startCancelableOperation() {
    ...
    return new cancellation/* CancellationTokenSource */.Qi();
}
/**
...
class DefaultLangiumDocumentFactory {
    ...
    fromTextDocument(textDocument, uri, token) {
        uri = uri !== null && uri !== void 0 ? uri : esm/* URI */.r.parse(textDocument.uri);
        if (cancellation/* CancellationToken */.XO.is(token)) {
...
class DefaultLangiumDocuments {
    ...
    get all() {
        return (0,stream/* stream */.Td)(this.documentMap.values());
    }
...
class DefaultLinker {
    ...
    async link(document, cancelToken = cancellation/* CancellationToken */.XO.None) {
        for (const node of (0,ast_utils/* streamAst */.jm)(document.parseResult.value)) {
            await interruptAndCheck(cancelToken);
            (0,ast_utils/* streamReferences */.DM)(node).forEach(ref => this.doLink(ref, document));
        }
    }
    doLink(refInfo, document) {
        ...
        if (ref._ref === undefined) {
            ...
            try {
                ...
                if ((0,syntax_tree/* isLinkingError */.Zl)(description)) {
    ...
    buildReference(node, property, refNode, refText) {
        ...
        const reference = {
            ...
            get ref() {
                var _a;
                if ((0,syntax_tree/* isAstNode */.ng)(this._ref)) {
                    // Most frequent case: the target is already resolved.
                    return this._ref;
                }
                else if ((0,syntax_tree/* isAstNodeDescription */.Nr)(this._nodeDescription)) {
                    ...
                    const document = (0,ast_utils/* findRootNode */.cQ)(node).$document;
                ...
                return (0,syntax_tree/* isAstNode */.ng)(this._ref) ? this._ref : undefined;
            },
            get $nodeDescription() {
                return this._nodeDescription;
            },
            get error() {
                return (0,syntax_tree/* isLinkingError */.Zl)(this._ref) ? this._ref : undefined;
            }
        };
        return reference;
    }
    ...
    createLinkingError(refInfo, targetDescription) {
        ...
        const document = (0,ast_utils/* findRootNode */.cQ)(refInfo.container).$document;
...
class DefaultNameProvider {
    ...
    getNameNode(node) {
        return (0,grammar_utils/* findNodeForProperty */.qO)(node.$cstNode, 'name');
    }
}
...
var UriUtils;
(function (UriUtils) {
    UriUtils.basename = esm/* Utils */.A.basename;
    UriUtils.dirname = esm/* Utils */.A.dirname;
    UriUtils.extname = esm/* Utils */.A.extname;
    UriUtils.joinPath = esm/* Utils */.A.joinPath;
    UriUtils.resolvePath = esm/* Utils */.A.resolvePath;
    function equals(a, b) {
    ...
    function normalize(uri) {
        return esm/* URI */.r.parse(uri.toString()).toString();
    }
...
class DefaultReferences {
    ...
    findDeclaration(sourceCstNode) {
        if (sourceCstNode) {
            const assignment = (0,grammar_utils/* findAssignment */.Rp)(sourceCstNode);
            const nodeElem = sourceCstNode.astNode;
            if (assignment && nodeElem) {
                const reference = nodeElem[assignment.feature];
                if ((0,syntax_tree/* isReference */.A_)(reference)) {
                    return reference.ref;
                }
                else if (Array.isArray(reference)) {
                    for (const ref of reference) {
                        if ((0,syntax_tree/* isReference */.A_)(ref) && ref.$refNode
            ...
            if (nodeElem) {
                ...
                if (nameNode && (nameNode === sourceCstNode || (0,cst_utils/* isChildNode */.pO)(sourceCstNode, nameNode))) {
                    return nodeElem;
                }
            }
        }
    ...
    findReferences(targetNode, options) {
        ...
        return (0,stream/* stream */.Td)(refs);
    }
    getReferenceToSelf(targetNode) {
        const nameNode = this.nameProvider.getNameNode(targetNode);
        if (nameNode) {
            const doc = (0,ast_utils/* getDocument */.YE)(targetNode);
            ...
            return {
                ...
                targetUri: doc.uri,
                targetPath: path,
                segment: (0,cst_utils/* toDocumentSegment */.SX)(nameNode),
                local: true
            };
        }
        return undefined;
...
class MultiMap {
     ...
     */
    get size() {
        return stream/* Reduction */.iD.sum((0,stream/* stream */.Td)(this.map.values()).map(a => a.length));
    }
    /**
     ...
     */
    entries() {
        return (0,stream/* stream */.Td)(this.map.entries())
     ...
     */
    keys() {
        return (0,stream/* stream */.Td)(this.map.keys());
    }
    /**
     * Returns a stream of values in the map.
     */
    values() {
        return (0,stream/* stream */.Td)(this.map.values()).flat();
    }
    /**
...
class DefaultScopeComputation {
     ...
     */
    async computeExportsForNode(parentNode, document, children = ast_utils/* streamContents */.VN, cancelToken = cancellation/* CancellationToken */.XO.None) {
        const exports = [];
    ...
    async computeLocalScopes(document, cancelToken = cancellation/* CancellationToken */.XO.None) {
        ...
        for (const node of (0,ast_utils/* streamAllContents */.Uo)(rootNode)) {
            await interruptAndCheck(cancelToken);
...
class MapScope {
    ...
    getAllElements() {
        let elementStream = (0,stream/* stream */.Td)(this.elements.values());
        if (this.outerScope) {
...
class DefaultScopeProvider {
    ...
    getScope(context) {
        ...
        const precomputed = (0,ast_utils/* getDocument */.YE)(context.container).precomputedScopes;
        if (precomputed) {
            let currentNode = context.container;
            do {
                const allDescriptions = precomputed.get(currentNode);
                if (allDescriptions.length > 0) {
                    scopes.push((0,stream/* stream */.Td)(allDescriptions).filter(desc => this.reflection.isSubtype(desc.type, referenceType)));
                }
    ...
    createScope(elements, outerScope, options) {
        return new StreamScope((0,stream/* stream */.Td)(elements), outerScope, options);
    }
    /**
    ...
    createScopeForNodes(elements, outerScope, options) {
        const s = (0,stream/* stream */.Td)(elements).map(e => {
...
class DefaultJsonSerializer {
    ...
    serialize(node, options) {
        ...
        try {
            this.currentDocument = (0,ast_utils/* getDocument */.YE)(node);
    ...
    replacer(key, value, { refText, sourceText, textRegions, comments, uriConverter }) {
        ...
        else if ((0,syntax_tree/* isReference */.A_)(value)) {
            const refValue = value.ref;
            const $refText = refText ? value.$refText : undefined;
            if (refValue) {
                const targetDocument = (0,ast_utils/* getDocument */.YE)(refValue);
                let targetUri = '';
        ...
        else if ((0,syntax_tree/* isAstNode */.ng)(value)) {
    ...
    addAstNodeRegionWithAssignmentsTo(node) {
        ...
        if (node.$cstNode) {
            ...
            Object.keys(node).filter(key => !key.startsWith('$')).forEach(key => {
                const propertyAssignments = (0,grammar_utils/* findNodesForProperty */.Bd)(node.$cstNode, key).map(createDocumentSegment);
        ...
        for (const [propertyName, item] of Object.entries(node)) {
            if (Array.isArray(item)) {
                for (let index = 0; index < item.length; index++) {
                    ...
                    else if ((0,syntax_tree/* isAstNode */.ng)(element)) {
            ...
            else if ((0,syntax_tree/* isAstNode */.ng)(item)) {
    ...
    reviveReference(container, property, root, reference, options) {
        ...
        if (reference.$ref) {
            ...
            if ((0,syntax_tree/* isAstNode */.ng)(ref)) {
                if (!refText) {
    ...
    getRefNode(root, uri, uriConverter) {
        try {
            ...
            if (fragmentIndex < 0) {
                const documentUri = uriConverter ? uriConverter(uri) : esm/* URI */.r.parse(uri);
            ...
            const documentUri = uriConverter ? uriConverter(uri.substring(0, fragmentIndex)) : esm/* URI */.r.parse(uri.substring(0, fragmentIndex));
            const document = this.langiumDocuments.getDocument(documentUri);
            if (!document) {
                return 'Could not find document for URI: ' + uri;
            }
...
class ValidationRegistry {
    ...
    register(checksRecord, thisObj = this, category = 'fast') {
        ...
        for (const [type, ch] of Object.entries(checksRecord)) {
            ...
            if (Array.isArray(callbacks)) {
                ...
                (0,errors/* assertUnreachable */.d)(callbacks);
            }
        }
    }
    ...
    getChecks(type, categories) {
        let checks = (0,stream/* stream */.Td)(this.entries.get(type))
...
class DefaultDocumentValidator {
    ...
    processParsingErrors(parseResult, diagnostics, _options) {
        for (const parserError of parseResult.parserErrors) {
            ...
            if (isNaN(parserError.token.startOffset)) {
                ...
                range = (0,cst_utils/* tokenToRange */.wf)(parserError.token);
            }
            if (range) {
                const diagnostic = {
    ...
    async validateAstBefore(rootNode, options, acceptor, cancelToken = cancellation/* CancellationToken */.XO.None) {
        var _a;
    ...
    async validateAstNodes(rootNode, options, acceptor, cancelToken = cancellation/* CancellationToken */.XO.None) {
        await Promise.all((0,ast_utils/* streamAst */.jm)(rootNode).map(async (node) => {
            await interruptAndCheck(cancelToken);
    ...
    async validateAstAfter(rootNode, options, acceptor, cancelToken = cancellation/* CancellationToken */.XO.None) {
        var _a;
...
function getDiagnosticRange(info) {
    ...
    if (typeof info.property === 'string') {
        cstNode = (0,grammar_utils/* findNodeForProperty */.qO)(info.node.$cstNode, info.property, info.index);
    }
    else if (typeof info.keyword === 'string') {
        cstNode = (0,grammar_utils/* findNodeForKeyword */.SS)(info.node.$cstNode, info.keyword, info.index);
    }
...
class DefaultAstNodeDescriptionProvider {
    ...
    createDescription(node, name, document) {
        const doc = document !== null && document !== void 0 ? document : (0,ast_utils/* getDocument */.YE)(node);
        ...
        let nameNodeSegment;
        const nameSegmentGetter = () => { var _a; return nameNodeSegment !== null && nameNodeSegment !== void 0 ? nameNodeSegment : (nameNodeSegment = (0,cst_utils/* toDocumentSegment */.SX)((_a = this.nameProvider.getNameNode(node)) !== null && _a !== void 0 ? _a : node.$cstNode)); };
        return {
            node,
            name,
            get nameSegment() {
            ...
            selectionSegment: (0,cst_utils/* toDocumentSegment */.SX)(node.$cstNode),
            type: node.$type,
            documentUri: doc.uri,
            path
        };
...
class DefaultReferenceDescriptionProvider {
    ...
    async createDescriptions(document, cancelToken = cancellation/* CancellationToken */.XO.None) {
        const descr = [];
        const rootNode = document.parseResult.value;
        for (const astNode of (0,ast_utils/* streamAst */.jm)(rootNode)) {
            await interruptAndCheck(cancelToken);
            (0,ast_utils/* streamReferences */.DM)(astNode).filter(refInfo => !(0,syntax_tree/* isLinkingError */.Zl)(refInfo)).forEach(refInfo => {
    ...
    createDescription(refInfo) {
        ...
        const docUri = (0,ast_utils/* getDocument */.YE)(refInfo.container).uri;
        return {
            sourceUri: docUri,
            sourcePath: this.nodeLocator.getAstNodePath(refInfo.container),
            targetUri: targetNodeDescr.documentUri,
            targetPath: targetNodeDescr.path,
            segment: (0,cst_utils/* toDocumentSegment */.SX)(refCstNode),
...
class DefaultDocumentBuilder {
    ...
    async update(changed, deleted, cancelToken = cancellation/* CancellationToken */.XO.None) {
        ...
        const allChangedUris = (0,stream/* stream */.Td)(changed).concat(deleted).map(uri => uri.toString()).toSet();
...
class DefaultIndexManager {
    ...
    findAllReferences(targetNode, astNodePath) {
        const targetDocUri = (0,ast_utils/* getDocument */.YE)(targetNode).uri;
        const result = [];
        ...
        return (0,stream/* stream */.Td)(result);
    }
    allElements(nodeType, uris) {
        let documentUris = (0,stream/* stream */.Td)(this.symbolIndex.keys());
        if (uris) {
...
class DefaultWorkspaceManager {
    ...
    getRootFolder(workspaceFolder) {
        return esm/* URI */.r.parse(workspaceFolder.uri);
    }
    /**
...
class DefaultLexerErrorMessageProvider {
    buildUnexpectedCharactersMessage(fullText, startOffset, length, line, column) {
        return api/* defaultLexerErrorProvider */.PW.buildUnexpectedCharactersMessage(fullText, startOffset, length, line, column);
    }
    buildUnableToPopLexerModeMessage(token) {
        return api/* defaultLexerErrorProvider */.PW.buildUnableToPopLexerModeMessage(token);
    }
}
...
class DefaultLexer {
    constructor(services) {
        ...
        const production = services.LanguageMetaData.mode === 'production';
        this.chevrotainLexer = new api/* Lexer */.JG(lexerTokens, {
...
function getLines(node) {
    ...
    const lines = content.split(regexp_utils/* NEWLINE_REGEXP */.TH);
    return lines;
}
...
function normalizeOption(option, start) {
    if (typeof option === 'string' || typeof option === 'object') {
        const escaped = typeof option === 'string' ? (0,regexp_utils/* escapeRegExp */.Nt)(option) : option.source;
        if (start) {
...
class JSDocDocumentationProvider {
    ...
    findNameInPrecomputedScopes(node, name) {
        const document = (0,ast_utils/* getDocument */.YE)(node);
...
class DefaultCommentProvider {
    ...
    getComment(node) {
        ...
        return (_a = (0,cst_utils/* findCommentNode */.v)(node.$cstNode, this.grammarConfig().multilineCommentRules)) === null || _a === void 0 ? void 0 : _a.text;
    }
}
...
class DefaultWorkspaceLock {
    ...
    enqueue(queue, action, cancellationToken = cancellation/* CancellationToken */.XO.None) {
...
class DefaultHydrator {
    ...
    createDehyrationContext(node) {
        ...
        for (const astNode of (0,ast_utils/* streamAst */.jm)(node)) {
            astNodes.set(astNode, {});
        }
        if (node.$cstNode) {
            for (const cstNode of (0,cst_utils/* streamCst */.NS)(node.$cstNode)) {
        ...
        for (const [name, value] of Object.entries(node)) {
            ...
            if (Array.isArray(value)) {
                ...
                for (const item of value) {
                    if ((0,syntax_tree/* isAstNode */.ng)(item)) {
                        arr.push(this.dehydrateAstNode(item, context));
                    }
                    else if ((0,syntax_tree/* isReference */.A_)(item)) {
    ...
    dehydrateCstNode(node, context) {
        ...
        if ((0,syntax_tree/* isRootCstNode */.br)(node)) {
        ...
        if ((0,syntax_tree/* isCompositeCstNode */.mD)(node)) {
            cstNode.content = node.content.map(child => this.dehydrateCstNode(child, context));
        }
        else if ((0,syntax_tree/* isLeafCstNode */.FC)(node)) {
    ...
    hydrateCstNode(cstNode, context, num = 0) {
        ...
        if ((0,syntax_tree/* isCompositeCstNode */.mD)(cstNodeObj)) {
    ...
    createGrammarElementIdMap() {
        let id = 0;
        for (const element of (0,ast_utils/* streamAst */.jm)(this.grammar)) {
            if ((0,ast/* isAbstractElement */.r1)(element)) {
...
function createDefaultCoreModule(context) {
    return {
        ...
        parser: {
            ...
            ValueConverter: () => new value_converter/* DefaultValueConverter */.d(),
            TokenBuilder: () => new token_builder/* DefaultTokenBuilder */.Q(),
...
var _toKey = __webpack_require__(901);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  ak: () => (/* reexport */ Alternation),
  mT: () => (/* reexport */ EMPTY_ALT),
  LT: () => (/* reexport */ EOF),
  jr: () => (/* reexport */ EmbeddedActionsParser),
  T6: () => (/* reexport */ LLkLookaheadStrategy),
  JG: () => (/* reexport */ Lexer),
  wL: () => (/* reexport */ model_NonTerminal),
  c$: () => (/* reexport */ Option),
  Y2: () => (/* reexport */ Repetition),
  $P: () => (/* reexport */ RepetitionMandatory),
  Cy: () => (/* reexport */ RepetitionMandatoryWithSeparator),
  Pp: () => (/* reexport */ RepetitionWithSeparator),
  BK: () => (/* reexport */ Terminal),
  PW: () => (/* reexport */ defaultLexerErrorProvider),
  my: () => (/* reexport */ defaultParserErrorProvider),
  jk: () => (/* reexport */ getLookaheadPaths),
  Sk: () => (/* reexport */ tokens_public_tokenLabel),
  G: () => (/* reexport */ tokenMatcher)
});
...
var lodash_es_values = __webpack_require__(8207);
// EXTERNAL MODULE: ./node_modules/lodash-es/isEmpty.js
var isEmpty = __webpack_require__(6401);
// EXTERNAL MODULE: ./node_modules/lodash-es/map.js
var lodash_es_map = __webpack_require__(4722);
...
var _basePickBy = __webpack_require__(9354);
// EXTERNAL MODULE: ./node_modules/lodash-es/_getAllKeysIn.js
var _getAllKeysIn = __webpack_require__(3973);
...
var _arraySome = __webpack_require__(3736);
...
var _baseIndexOf = __webpack_require__(818);
...
// EXTERNAL MODULE: ./node_modules/lodash-es/flatten.js
var lodash_es_flatten = __webpack_require__(4098);
...
var api = __webpack_require__(5186);
...
var _baseFilter = __webpack_require__(1790);
...
var _arrayIncludes = __webpack_require__(5530);
// EXTERNAL MODULE: ./node_modules/lodash-es/_arrayIncludesWith.js
var _arrayIncludesWith = __webpack_require__(7809);
...
var find = __webpack_require__(6145);
...
let regExpAstCache = {};
const regExpParser = new api/* RegExpParser */.H();
...
class CharCodeFinder extends api/* BaseRegExpVisitor */.z {
...
function findEndOfInputAnchor(tokenTypes) {
    class EndAnchorFinder extends api/* BaseRegExpVisitor */.z {
        constructor() {
            super(...arguments);
            this.found = false;
        }
...
function findStartOfInputAnchor(tokenTypes) {
    class StartAnchorFinder extends api/* BaseRegExpVisitor */.z {
        constructor() {
            super(...arguments);
            this.found = false;
        }
...
var noop = __webpack_require__(2302);
// EXTERNAL MODULE: ./node_modules/lodash-es/last.js
var last = __webpack_require__(6666);
...
function validateGrammar(topLevels, tokenTypes, errMsgProvider, grammarName) {
    const duplicateErrors = (0,flatMap/* default */.A)(topLevels, (currTopLevel) => validateDuplicateProductions(currTopLevel, errMsgProvider));
    const termsNamespaceConflictErrors = checkTerminalAndNoneTerminalsNameSpace(topLevels, tokenTypes, errMsgProvider);
    const tooManyAltsErrors = (0,flatMap/* default */.A)(topLevels, (curRule) => validateTooManyAlts(curRule, errMsgProvider));
    const duplicateRulesError = (0,flatMap/* default */.A)(topLevels, (curRule) => validateRuleDoesNotAlreadyExist(curRule, topLevels, grammarName, errMsgProvider));
...
function validateNoLeftRecursion(topRule, currRule, errMsgProvider, path = []) {
    ...
    if ((0,isEmpty/* default */.A)(nextNonTerminals)) {
        ...
        const errorsFromNextSteps = (0,flatMap/* default */.A)(validNextSteps, (currRefRule) => {
...
function validateEmptyOrAlternative(topLevelRule, errMsgProvider) {
    ...
    const errors = (0,flatMap/* default */.A)(ors, (currOr) => {
        const exceptLast = lodash_es_dropRight(currOr.definition);
        return (0,flatMap/* default */.A)(exceptLast, (currAlternative, currAltIdx) => {
...
function checkPrefixAlternativesAmbiguities(alternatives, alternation, rule, errMsgProvider) {
    ...
    const errors = lodash_es_compact((0,flatMap/* default */.A)(pathsAndIndices, (currPathAndIdx) => {
...
class LLkLookaheadStrategy {
    ...
    validateNoLeftRecursion(rules) {
        return (0,flatMap/* default */.A)(rules, (currTopRule) => validateNoLeftRecursion(currTopRule, currTopRule, defaultGrammarValidatorErrorProvider));
    }
    validateEmptyOrAlternatives(rules) {
        return (0,flatMap/* default */.A)(rules, (currTopRule) => validateEmptyOrAlternative(currTopRule, defaultGrammarValidatorErrorProvider));
    }
    validateAmbiguousAlternationAlternatives(rules, maxLookahead) {
        return (0,flatMap/* default */.A)(rules, (currTopRule) => validateAmbiguousAlternationAlternatives(currTopRule, maxLookahead, defaultGrammarValidatorErrorProvider));
    }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DM: () => (/* binding */ streamReferences),
/* harmony export */   OP: () => (/* binding */ assignMandatoryProperties),
/* harmony export */   SD: () => (/* binding */ linkContentToContainer),
/* harmony export */   Uo: () => (/* binding */ streamAllContents),
/* harmony export */   VN: () => (/* binding */ streamContents),
/* harmony export */   XG: () => (/* binding */ getContainerOfType),
/* harmony export */   YE: () => (/* binding */ getDocument),
/* harmony export */   cQ: () => (/* binding */ findRootNode),
/* harmony export */   jm: () => (/* binding */ streamAst)
/* harmony export */ });
/* unused harmony exports hasContainerOfType, findLocalReferences, copyAstNode */
/* harmony import */ var _syntax_tree_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2479);
/* harmony import */ var _stream_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1719);
/* harmony import */ var _cst_utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6373);
/******************************************************************************
 * Copyright 2021 TypeFox GmbH
 * This program and the accompanying materials are made available under the
 * terms of the MIT License, which is available in the project root.
        ...
        if (!name.startsWith('$')) {
            if (Array.isArray(value)) {
                value.forEach((item, index) => {
                    if ((0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_0__/* .isAstNode */ .ng)(item)) {
                        item.$container = node;
            ...
            else if ((0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_0__/* .isAstNode */ .ng)(value)) {
...
function streamContents(node, options) {
    ...
    return new _stream_js__WEBPACK_IMPORTED_MODULE_1__/* .StreamImpl */ .fq(() => ({
        ...
        while (state.keyIndex < state.keys.length) {
            ...
            if (!property.startsWith('$')) {
                ...
                if ((0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_0__/* .isAstNode */ .ng)(value)) {
                    state.keyIndex++;
                    ...
                    while (state.arrayIndex < value.length) {
                        ...
                        if ((0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_0__/* .isAstNode */ .ng)(element) && isAstNodeInRange(element, range)) {
        ...
        return _stream_js__WEBPACK_IMPORTED_MODULE_1__/* .DONE_RESULT */ .Rf;
    });
}
/**
...
function streamAllContents(root, options) {
    ...
    return new _stream_js__WEBPACK_IMPORTED_MODULE_1__/* .TreeStreamImpl */ .Vj(root, node => streamContents(node, options));
}
/**
 * Create a stream of all AST nodes that are directly and indirectly contained in the given root node,
 * including the root node itself.
...
function streamAst(root, options) {
    if (!root) {
        ...
        return new _stream_js__WEBPACK_IMPORTED_MODULE_1__/* .TreeStreamImpl */ .Vj(root, () => []);
    }
    return new _stream_js__WEBPACK_IMPORTED_MODULE_1__/* .TreeStreamImpl */ .Vj(root, node => streamContents(node, options), { includeRoot: true });
}
function isAstNodeInRange(astNode, range) {
    ...
    return (0,_cst_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .inRange */ .r4)(nodeRange, range);
}
/**
...
function streamReferences(node) {
    return new _stream_js__WEBPACK_IMPORTED_MODULE_1__/* .StreamImpl */ .fq(() => ({
        ...
        while (state.keyIndex < state.keys.length) {
            ...
            if (!property.startsWith('$')) {
                const value = node[property];
                if ((0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_0__/* .isReference */ .A_)(value)) {
                    state.keyIndex++;
                    ...
                    while (state.arrayIndex < value.length) {
                        const index = state.arrayIndex++;
                        const element = value[index];
                        if ((0,_syntax_tree_js__WEBPACK_IMPORTED_MODULE_0__/* .isReference */ .A_)(element)) {
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseGetTag_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8496);
/* harmony import */ var _isArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2049);
...
var PieTokenBuilder = class extends _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .AbstractMermaidTokenBuilder */ .mR {
  static {
    (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "PieTokenBuilder");
  }
  constructor() {
    super(["pie", "showData"]);
  }
...
var PieValueConverter = class extends _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .AbstractMermaidValueConverter */ .dg {
  static {
    (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "PieValueConverter");
  }
  runCustomConverter(rule, input, _cstNode) {
...
var PieModule = {
  parser: {
    TokenBuilder: /* @__PURE__ */ (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => new PieTokenBuilder(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => new PieValueConverter(), "ValueConverter")
  }
};
function createPieServices(context = langium__WEBPACK_IMPORTED_MODULE_1__/* .EmptyFileSystem */ .D) {
  ...
  const Pie = (0,langium__WEBPACK_IMPORTED_MODULE_2__/* .inject */ .WQ)(
    (0,langium__WEBPACK_IMPORTED_MODULE_3__/* .createDefaultCoreModule */ .t)({ shared }),
    _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .PieGeneratedModule */ .KX,
    PieModule
  );
  shared.ServiceRegistry.register(Pie);
  return { shared, Pie };
}
(0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(createPieServices, "createPieServices");
...
const ral_1 = __webpack_require__(9590);
const Is = __webpack_require__(966);
...
var PacketTokenBuilder = class extends _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .AbstractMermaidTokenBuilder */ .mR {
  static {
    (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "PacketTokenBuilder");
  }
  constructor() {
    super(["packet-beta"]);
  }
...
var PacketModule = {
  parser: {
    TokenBuilder: /* @__PURE__ */ (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => new PacketTokenBuilder(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ (0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => new _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CommonValueConverter */ .Tm(), "ValueConverter")
  }
};
function createPacketServices(context = langium__WEBPACK_IMPORTED_MODULE_1__/* .EmptyFileSystem */ .D) {
  ...
  const Packet = (0,langium__WEBPACK_IMPORTED_MODULE_2__/* .inject */ .WQ)(
    (0,langium__WEBPACK_IMPORTED_MODULE_3__/* .createDefaultCoreModule */ .t)({ shared }),
    _chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .PacketGeneratedModule */ .AM,
    PacketModule
  );
  shared.ServiceRegistry.register(Packet);
  return { shared, Packet };
}
(0,_chunk_7PKI6E2E_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(createPacketServices, "createPacketServices");
