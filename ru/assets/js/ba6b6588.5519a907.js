...
const site_docs_scripting_scene_intro_md_ba6_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"scripting/scene/intro","title":"Создание сцены","description":"Всё о том, как создавать сцены и работать с ними.","source":"@site/docs/scripting/scene/intro.md","sourceDirName":"scripting/scene","slug":"/scripting/scene/intro","permalink":"/HollowEngineDocumentation/ru/docs/scripting/scene/intro","draft":false,"unlisted":false,"editUrl":"https://github.com/facebook/docusaurus/tree/main/packages/create-docusaurus/templates/shared/docs/scripting/scene/intro.md","tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"sidebar_position":1,"title":"Создание сцены"},"sidebar":"tutorialSidebar","previous":{"title":"Сцена","permalink":"/HollowEngineDocumentation/ru/docs/category/сцена"},"next":{"title":"Персонажи","permalink":"/HollowEngineDocumentation/ru/docs/category/персонажи"}}');
