...
const site_docs_scripting_scene_effect_audio_md_e12_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"scripting/scene/effect/audio","title":"Аудио","description":"Воспроизводите любое аудио прямо в игре!","source":"@site/docs/scripting/scene/effect/audio.md","sourceDirName":"scripting/scene/effect","slug":"/scripting/scene/effect/audio","permalink":"/HollowEngineDocumentation/ru/docs/scripting/scene/effect/audio","draft":false,"unlisted":false,"editUrl":"https://github.com/facebook/docusaurus/tree/main/packages/create-docusaurus/templates/shared/docs/scripting/scene/effect/audio.md","tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"sidebar_position":1,"title":"Аудио"},"sidebar":"tutorialSidebar","previous":{"title":"Эффекты","permalink":"/HollowEngineDocumentation/ru/docs/category/эффекты"},"next":{"title":"Bedrock-партиклы","permalink":"/HollowEngineDocumentation/ru/docs/scripting/scene/effect/bedrock-particles"}}');
