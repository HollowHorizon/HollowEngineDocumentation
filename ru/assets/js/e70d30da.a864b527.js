...
const site_docs_scripting_scene_npc_actions_md_e70_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"scripting/scene/npc/npc-actions","title":"Действия Персонажей","description":"Научите его писать за вас скрипты.","source":"@site/docs/scripting/scene/npc/actions.md","sourceDirName":"scripting/scene/npc","slug":"/scripting/scene/npc/npc-actions","permalink":"/hollowengine.github.io/ru/docs/scripting/scene/npc/npc-actions","draft":false,"unlisted":false,"editUrl":"https://github.com/facebook/docusaurus/tree/main/packages/create-docusaurus/templates/shared/docs/scripting/scene/npc/actions.md","tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"sidebar_position":2,"title":"Действия Персонажей","id":"npc-actions","desc":"NaN"},"sidebar":"tutorialSidebar","previous":{"title":"Создание Персонажа","permalink":"/hollowengine.github.io/ru/docs/scripting/scene/npc/creating"},"next":{"title":"Контроллер анимаций","permalink":"/hollowengine.github.io/ru/docs/scripting/scene/npc/controller"}}');
